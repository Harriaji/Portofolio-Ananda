...
@section('content-title', 'Create Contact '. $siswa->nama)
@section ('main')
    ...
    <div class="col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                @endif
                    <form method="POST" enctype="multipart/form-data" action="{{route('make.kontak')}}">
                    @csrf
                ...
                <div>
                        <label for="desc_kontak">Deskripsi Kontak</label>
                        <input type="text" class="form-control" id="desc_kontak" name="desc_kontak"  value="{{old('desc_kontak')}}" >
                    </div>
                    <br>
